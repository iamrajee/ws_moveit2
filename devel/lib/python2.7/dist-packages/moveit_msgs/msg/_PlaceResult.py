...
class PlaceResult(genpy.Message):
  _md5sum = "d014a3e48b7473b141d3d3393c792015"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v44.id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v47.key = str[start:end].decode('utf-8')
        else:
          _v47.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v47.db = str[start:end].decode('utf-8')
        else:
          _v47.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v44.primitives = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v44.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v44.meshes = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v44.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v44.subframe_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v44.subframe_poses.append(val3)
        start = end
        end += 1
      ...
      for i in range(0, length):
        ...
        _v64 = val1.multi_dof_joint_trajectory
        _v65 = _v64.header
        start = end
        end += 4
    ...
    try:
      ...
      for val1 in self.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        length = len(_v81.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.primitives:
          buff.write(_get_struct_B().pack(val3.type))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v81.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.primitive_poses:
          _v85 = val3.position
          _x = _v85
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v86
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v81.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v81.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.mesh_poses:
          _v87 = val3.position
          _x = _v87
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v88
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v81.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.planes:
          buff.write(val3.coef.tostring())
        length = len(_v81.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.plane_poses:
          _v89 = val3.position
          _x = _v89
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v90
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v81.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.pack('<I%ss'%length, length, val3))
        length = len(_v81.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v81.subframe_poses:
          _v91 = val3.position
          _x = _v91
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v92
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v81.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.trajectory_stages:
        ...
        for val3 in _v97.points:
          ...
          _x = _v100
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        _v101 = val1.multi_dof_joint_trajectory
        _v102 = _v101.header
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v118.id = str[start:end].decode('utf-8')
        else:
          _v118.id = str[start:end]
        _v121 = _v118.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v121.key = str[start:end].decode('utf-8')
        else:
          _v121.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v121.db = str[start:end].decode('utf-8')
        else:
          _v121.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v118.primitives = []
        for i in range(0, length):
          ...
          _v118.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v118.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v122 = val3.position
          _x = _v122
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v118.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v118.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v118.plane_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v118.subframe_names = []
        for i in range(0, length):
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v118.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v118.subframe_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v128 = val3.position
          _x = _v128
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v118.subframe_poses.append(val3)
        start = end
        end += 1
        (_v118.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
      ...
      for i in range(0, length):
        ...
        _v138 = val1.multi_dof_joint_trajectory
        _v139 = _v138.header
        start = end
        end += 4
