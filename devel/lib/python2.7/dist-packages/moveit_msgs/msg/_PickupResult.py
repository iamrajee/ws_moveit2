...
class PickupResult(genpy.Message):
  _md5sum = "509d90e0895422d7f77846d16586fd11"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v65 = val1.multi_dof_joint_trajectory
        _v66 = _v65.header
        start = end
        end += 4
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v137.points.append(val3)
        _v141 = val1.multi_dof_joint_trajectory
        _v142 = _v141.header
        start = end
        end += 4
