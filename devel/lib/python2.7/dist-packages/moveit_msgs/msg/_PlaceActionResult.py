...
class PlaceActionResult(genpy.Message):
  _md5sum = "99cd74fbdec389a51555559c26cfecec"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.result.trajectory_start.is_diff))
      ...
      for val1 in self.result.place_location.allowed_touch_objects:
        ...
        if python3 or type(val1) == unicode:
          ...
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      buff.write(_get_struct_d().pack(self.result.planning_time))
