...
class GetPositionFKRequest(genpy.Message):
  _md5sum = "9d27dcb1340fb84f5c724b575523cb36"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v29.id = str[start:end].decode('utf-8')
        else:
          _v29.id = str[start:end]
        _v32 = _v29.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          _v29.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v29.primitive_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v29.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v29.meshes = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v29.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v29.subframe_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v29.subframe_poses.append(val3)
        start = end
        end += 1
        (_v29.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
    ...
    try:
      ...
      for val1 in self.robot_state.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        length = len(_v51.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.primitives:
          buff.write(_get_struct_B().pack(val3.type))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v51.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.primitive_poses:
          _v55 = val3.position
          _x = _v55
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v56
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v51.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v51.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.mesh_poses:
          _v57 = val3.position
          _x = _v57
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v58
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v51.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.planes:
          buff.write(val3.coef.tostring())
        length = len(_v51.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.plane_poses:
          _v59 = val3.position
          _x = _v59
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v60
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v51.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.pack('<I%ss'%length, length, val3))
        length = len(_v51.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v51.subframe_poses:
          _v61 = val3.position
          _x = _v61
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v62
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v51.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v73.id = str[start:end].decode('utf-8')
        else:
          _v73.id = str[start:end]
        _v76 = _v73.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v76.key = str[start:end].decode('utf-8')
        else:
          _v76.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v76.db = str[start:end].decode('utf-8')
        else:
          _v76.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v73.primitives = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v73.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v73.subframe_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v73.subframe_poses.append(val3)
        start = end
        end += 1
        (_v73.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.pose_stamped:
        _v89 = val1.header
        buff.write(_get_struct_I().pack(_v89.seq))
        _v90 = _v89.stamp
        _x = _v90
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v89.frame_id
...
class GetPositionFK(object):
  ...
  _md5sum = '492238952ca9c4fdab2632a7cdc4bde9'
