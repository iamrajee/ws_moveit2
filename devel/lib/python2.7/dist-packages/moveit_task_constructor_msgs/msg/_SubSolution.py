...
"""autogenerated by genpy from moveit_task_constructor_msgs/SubSolution.msg. Do not edit."""
import sys
...
class SubSolution(genpy.Message):
  _md5sum = "cad7989816e3b99e3abb2b6661af1df0"
  _type = "moveit_task_constructor_msgs/SubSolution"
...
float32 a
"""
  __slots__ = ['info','sub_solution_id']
  _slot_types = ['moveit_task_constructor_msgs/SolutionInfo','uint32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SubSolution, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.info is None:
        self.info = moveit_task_constructor_msgs.msg.SolutionInfo()
      if self.sub_solution_id is None:
        self.sub_solution_id = []
    else:
      self.info = moveit_task_constructor_msgs.msg.SolutionInfo()
      self.sub_solution_id = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.sub_solution_id)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.sub_solution_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.sub_solution_id = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(self.sub_solution_id.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.sub_solution_id = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
