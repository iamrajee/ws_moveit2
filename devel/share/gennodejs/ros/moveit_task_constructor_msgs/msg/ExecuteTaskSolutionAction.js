...
class ExecuteTaskSolutionAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ExecuteTaskSolutionAction
    // Serialize message field [action_goal]
    bufferOffset = ExecuteTaskSolutionActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = ExecuteTaskSolutionActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = ExecuteTaskSolutionActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ExecuteTaskSolutionAction
    let len;
    let data = new ExecuteTaskSolutionAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = ExecuteTaskSolutionActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = ExecuteTaskSolutionActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = ExecuteTaskSolutionActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += ExecuteTaskSolutionActionGoal.getMessageSize(object.action_goal);
    length += ExecuteTaskSolutionActionResult.getMessageSize(object.action_result);
    length += ExecuteTaskSolutionActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteTaskSolutionAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = ExecuteTaskSolutionActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new ExecuteTaskSolutionActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = ExecuteTaskSolutionActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new ExecuteTaskSolutionActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = ExecuteTaskSolutionActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new ExecuteTaskSolutionActionFeedback()
    }
...
module.exports = ExecuteTaskSolutionAction;
