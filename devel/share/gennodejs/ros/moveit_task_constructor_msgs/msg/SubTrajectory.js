...
class SubTrajectory {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('scene_diff')) {
        this.scene_diff = initObj.scene_diff
      }
      else {
        this.scene_diff = new moveit_msgs.msg.PlanningScene();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SubTrajectory
    ...
    // Serialize message field [scene_diff]
    bufferOffset = moveit_msgs.msg.PlanningScene.serialize(obj.scene_diff, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SubTrajectory
    let len;
    let data = new SubTrajectory(null);
    ...
    // Deserialize message field [scene_diff]
    data.scene_diff = moveit_msgs.msg.PlanningScene.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += moveit_msgs.msg.PlanningScene.getMessageSize(object.scene_diff);
    return length;
  }

  static datatype() {
    // Returns string type for a message object
    return 'moveit_task_constructor_msgs/SubTrajectory';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '2f97340df66a4632a2b2972a088b9064';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SubTrajectory(null);
    ...
    if (msg.scene_diff !== undefined) {
      resolved.scene_diff = moveit_msgs.msg.PlanningScene.Resolve(msg.scene_diff)
    }
    else {
      resolved.scene_diff = new moveit_msgs.msg.PlanningScene()
    }
