...
class ExecuteTaskSolutionActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteTaskSolutionResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteTaskSolutionActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = ExecuteTaskSolutionResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteTaskSolutionActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ExecuteTaskSolutionResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ExecuteTaskSolutionResult()
    }
...
module.exports = ExecuteTaskSolutionActionResult;
