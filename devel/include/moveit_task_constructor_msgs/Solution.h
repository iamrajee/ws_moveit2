// Generated by gencpp from file moveit_task_constructor_msgs/Solution.msg
// DO NOT EDIT!


#ifndef MOVEIT_TASK_CONSTRUCTOR_MSGS_MESSAGE_SOLUTION_H
#define MOVEIT_TASK_CONSTRUCTOR_MSGS_MESSAGE_SOLUTION_H
...
struct Solution_
{
  ...
  _task_id_type task_id;
   ...
   typedef  ::moveit_msgs::PlanningScene_<ContainerAllocator>  _start_scene_type;
  _start_scene_type start_scene;

   typedef std::vector< ::moveit_task_constructor_msgs::SubSolution_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::moveit_task_constructor_msgs::SubSolution_<ContainerAllocator> >::other >  _sub_solution_type;
  _sub_solution_type sub_solution;

   typedef std::vector< ::moveit_task_constructor_msgs::SubTrajectory_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::moveit_task_constructor_msgs::SubTrajectory_<ContainerAllocator> >::other >  _sub_trajectory_type;
  ...
  typedef boost::shared_ptr< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> const> ConstPtr;

}; // struct Solution_

typedef ::moveit_task_constructor_msgs::Solution_<std::allocator<void> > Solution;

typedef boost::shared_ptr< ::moveit_task_constructor_msgs::Solution > SolutionPtr;
typedef boost::shared_ptr< ::moveit_task_constructor_msgs::Solution const> SolutionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_task_constructor_msgs::Solution_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf471eaed79942072ULL;
  static const uint64_t static_value2 = 0xef3a9c133a3a7cc1ULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.process_id);
      stream.next(m.task_id);
      stream.next(m.start_scene);
      stream.next(m.sub_solution);
      stream.next(m.sub_trajectory);
    }
...
template<class ContainerAllocator>
struct Printer< ::moveit_task_constructor_msgs::Solution_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_task_constructor_msgs::Solution_<ContainerAllocator>& v)
  {
    s << indent << "process_id: ";
    ...
    s << indent << "start_scene: ";
    s << std::endl;
    Printer< ::moveit_msgs::PlanningScene_<ContainerAllocator> >::stream(s, indent + "  ", v.start_scene);
    s << indent << "sub_solution[]" << std::endl;
    for (size_t i = 0; i < v.sub_solution.size(); ++i)
    {
      s << indent << "  sub_solution[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::moveit_task_constructor_msgs::SubSolution_<ContainerAllocator> >::stream(s, indent + "    ", v.sub_solution[i]);
    }
    s << indent << "sub_trajectory[]" << std::endl;
    for (size_t i = 0; i < v.sub_trajectory.size(); ++i)
    {
      s << indent << "  sub_trajectory[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::moveit_task_constructor_msgs::SubTrajectory_<ContainerAllocator> >::stream(s, indent + "    ", v.sub_trajectory[i]);
    }
  }
};
...
#endif // MOVEIT_TASK_CONSTRUCTOR_MSGS_MESSAGE_SOLUTION_H
