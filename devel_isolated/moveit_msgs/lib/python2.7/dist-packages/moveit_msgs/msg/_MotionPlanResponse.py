...
class MotionPlanResponse(genpy.Message):
  _md5sum = "982c593b51eb488dbfb9ea1af7a6151a"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v40.key = str[start:end].decode('utf-8')
        else:
          _v40.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v40.db = str[start:end].decode('utf-8')
        else:
          _v40.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v37.primitives = []
        for i in range(0, length):
          ...
          _v37.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v37.primitive_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v37.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v37.meshes = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v37.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v37.subframe_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v37.subframe_poses.append(val3)
        start = end
        end += 1
        (_v37.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
    ...
    try:
      ...
      for val1 in self.trajectory_start.attached_collision_objects:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        length = len(_v67.primitives)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.primitives:
          buff.write(_get_struct_B().pack(val3.type))
          length = len(val3.dimensions)
          buff.write(_struct_I.pack(length))
          pattern = '<%sd'%length
          buff.write(val3.dimensions.tostring())
        length = len(_v67.primitive_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.primitive_poses:
          _v71 = val3.position
          _x = _v71
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v72
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v67.meshes)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.meshes:
          length = len(val3.triangles)
          buff.write(_struct_I.pack(length))
          for val4 in val3.triangles:
          ...
          for val4 in val3.vertices:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v67.mesh_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.mesh_poses:
          _v73 = val3.position
          _x = _v73
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v74
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v67.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.planes:
          buff.write(val3.coef.tostring())
        length = len(_v67.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.plane_poses:
          _v75 = val3.position
          _x = _v75
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v76
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v67.subframe_names)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.subframe_names:
          length = len(val3)
          if python3 or type(val3) == unicode:
            val3 = val3.encode('utf-8')
            length = len(val3)
          buff.write(struct.pack('<I%ss'%length, length, val3))
        length = len(_v67.subframe_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v67.subframe_poses:
          _v77 = val3.position
          _x = _v77
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          ...
          _x = _v78
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v67.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v97.id = str[start:end].decode('utf-8')
        else:
          _v97.id = str[start:end]
        _v100 = _v97.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          _v100.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v100.db = str[start:end].decode('utf-8')
        else:
        ...
        for i in range(0, length):
          ...
          _v97.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v97.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v101 = val3.position
          _x = _v101
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v97.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v97.meshes = []
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val3 = str[start:end]
          _v97.subframe_names.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v97.subframe_poses = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v97.subframe_poses.append(val3)
        start = end
        end += 1
        (_v97.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
