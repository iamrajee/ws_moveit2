...
class CollisionObject(genpy.Message):
  _md5sum = "f5dff86df1238076802d21d63471714d"
...
"""
  ...
  __slots__ = ['header','id','type','primitives','primitive_poses','meshes','mesh_poses','planes','plane_poses','subframe_names','subframe_poses','operation']
  _slot_types = ['std_msgs/Header','string','object_recognition_msgs/ObjectType','shape_msgs/SolidPrimitive[]','geometry_msgs/Pose[]','shape_msgs/Mesh[]','geometry_msgs/Pose[]','shape_msgs/Plane[]','geometry_msgs/Pose[]','string[]','geometry_msgs/Pose[]','byte']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,type,primitives,primitive_poses,meshes,mesh_poses,planes,plane_poses,subframe_names,subframe_poses,operation
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.subframe_poses:
        ...
        _x = _v8
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      buff.write(_get_struct_b().pack(self.operation))
