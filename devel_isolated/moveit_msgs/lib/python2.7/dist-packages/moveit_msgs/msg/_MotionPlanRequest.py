...
class MotionPlanRequest(genpy.Message):
  _md5sum = "385bccfd9b5015cda14b0522eddd9464"
...
Vector3  angular
"""
  __slots__ = ['workspace_parameters','start_state','goal_constraints','path_constraints','trajectory_constraints','reference_trajectories','planner_id','group_name','num_planning_attempts','allowed_planning_time','max_velocity_scaling_factor','max_acceleration_scaling_factor']
  _slot_types = ['moveit_msgs/WorkspaceParameters','moveit_msgs/RobotState','moveit_msgs/Constraints[]','moveit_msgs/Constraints','moveit_msgs/TrajectoryConstraints','moveit_msgs/GenericTrajectory[]','string','string','int32','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       workspace_parameters,start_state,goal_constraints,path_constraints,trajectory_constraints,reference_trajectories,planner_id,group_name,num_planning_attempts,allowed_planning_time,max_velocity_scaling_factor,max_acceleration_scaling_factor
