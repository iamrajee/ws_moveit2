// Generated by gencpp from file moveit_task_constructor_msgs/GetSolutionResponse.msg
// DO NOT EDIT!


#ifndef MOVEIT_TASK_CONSTRUCTOR_MSGS_MESSAGE_GETSOLUTIONRESPONSE_H
#define MOVEIT_TASK_CONSTRUCTOR_MSGS_MESSAGE_GETSOLUTIONRESPONSE_H
...
struct GetSolutionResponse_
{
  typedef GetSolutionResponse_<ContainerAllocator> Type;

  GetSolutionResponse_()
    : solution()  {
    }
  GetSolutionResponse_(const ContainerAllocator& _alloc)
    : solution(_alloc)  {
  (void)_alloc;
    }
  ...
  typedef boost::shared_ptr< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetSolutionResponse_

typedef ::moveit_task_constructor_msgs::GetSolutionResponse_<std::allocator<void> > GetSolutionResponse;

typedef boost::shared_ptr< ::moveit_task_constructor_msgs::GetSolutionResponse > GetSolutionResponsePtr;
typedef boost::shared_ptr< ::moveit_task_constructor_msgs::GetSolutionResponse const> GetSolutionResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf7004e140d59ff39ULL;
  static const uint64_t static_value2 = 0x52fa761d4bc31d0eULL;
};

template<class ContainerAllocator>
struct DataType< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_task_constructor_msgs::GetSolutionResponse_<ContainerAllocator>& v)
  {
    s << indent << "solution: ";
    s << std::endl;
...
#endif // MOVEIT_TASK_CONSTRUCTOR_MSGS_MESSAGE_GETSOLUTIONRESPONSE_H
