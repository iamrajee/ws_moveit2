...
"""autogenerated by genpy from moveit_task_constructor_msgs/ExecuteTaskSolutionGoal.msg. Do not edit."""
import sys
...
class ExecuteTaskSolutionGoal(genpy.Message):
  _md5sum = "f7004e140d59ff3952fa761d4bc31d0e"
  _type = "moveit_task_constructor_msgs/ExecuteTaskSolutionGoal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteTaskSolutionGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.solution.start_scene.robot_state.joint_state.position))
      length = len(self.solution.start_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.solution.start_scene.robot_state.joint_state.velocity))
      length = len(self.solution.start_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.solution.start_scene.robot_state.joint_state.effort))
      _x = self
      ...
      buff.write(_get_struct_B().pack(self.solution.start_scene.robot_state.is_diff))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.solution.start_scene.allowed_collision_matrix.default_entry_values))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.solution.start_scene.world.octomap.octomap.binary))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.solution.start_scene.world.octomap.octomap.resolution))
      length = len(self.solution.start_scene.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.solution.start_scene.world.octomap.octomap.data))
      buff.write(_get_struct_B().pack(self.solution.start_scene.is_diff))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.solution.process_id = str[start:end].decode('utf-8')
      else:
        self.solution.process_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.solution.task_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.solution.start_scene.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.solution.start_scene.robot_state.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.solution.start_scene.robot_state.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.solution.start_scene.robot_state.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.solution.start_scene.robot_state.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.solution.start_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.solution.start_scene.robot_model_name = str[start:end].decode('utf-8')
      else:
      ...
      self.solution.start_scene.allowed_collision_matrix.default_entry_values = struct.unpack(pattern, str[start:end])
      ...
      if python3:
        self.solution.start_scene.world.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.solution.start_scene.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.solution.start_scene.world.octomap.octomap.id = str[start:end].decode('utf-8')
      else:
      ...
      self.solution.start_scene.world.octomap.octomap.data = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
