...
"""autogenerated by genpy from moveit_task_constructor_msgs/ExecuteTaskSolutionAction.msg. Do not edit."""
import sys
...
class ExecuteTaskSolutionAction(genpy.Message):
  _md5sum = "d9f2722b802d32ce967517c0c9dd14f2"
  _type = "moveit_task_constructor_msgs/ExecuteTaskSolutionAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

ExecuteTaskSolutionActionGoal action_goal
ExecuteTaskSolutionActionResult action_result
ExecuteTaskSolutionActionFeedback action_feedback

================================================================================
MSG: moveit_task_constructor_msgs/ExecuteTaskSolutionActionGoal
...
================================================================================
MSG: moveit_task_constructor_msgs/ExecuteTaskSolutionActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: moveit_task_constructor_msgs/ExecuteTaskSolutionActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
ExecuteTaskSolutionFeedback feedback

================================================================================
MSG: moveit_task_constructor_msgs/ExecuteTaskSolutionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
"""
  ...
  _slot_types = ['moveit_task_constructor_msgs/ExecuteTaskSolutionActionGoal','moveit_task_constructor_msgs/ExecuteTaskSolutionActionResult','moveit_task_constructor_msgs/ExecuteTaskSolutionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteTaskSolutionAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = moveit_task_constructor_msgs.msg.ExecuteTaskSolutionActionGoal()
      if self.action_result is None:
        self.action_result = moveit_task_constructor_msgs.msg.ExecuteTaskSolutionActionResult()
      if self.action_feedback is None:
        self.action_feedback = moveit_task_constructor_msgs.msg.ExecuteTaskSolutionActionFeedback()
    else:
      self.action_goal = moveit_task_constructor_msgs.msg.ExecuteTaskSolutionActionGoal()
      self.action_result = moveit_task_constructor_msgs.msg.ExecuteTaskSolutionActionResult()
      self.action_feedback = moveit_task_constructor_msgs.msg.ExecuteTaskSolutionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.solution.process_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.solution.task_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.solution.start_scene.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.solution.start_scene.robot_state.joint_state.header.seq, _x.action_goal.goal.solution.start_scene.robot_state.joint_state.header.stamp.secs, _x.action_goal.goal.solution.start_scene.robot_state.joint_state.header.stamp.nsecs))
      _x = self.action_goal.goal.solution.start_scene.robot_state.joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.robot_state.joint_state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.solution.start_scene.robot_state.joint_state.position))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.transforms:
      ...
      length = len(self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.twist:
        _v3 = val1.linear
        _x = _v3
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v4 = val1.angular
        _x = _v4
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.wrench:
        _v5 = val1.force
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v6 = val1.torque
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.attached_collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.robot_state.attached_collision_objects:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      buff.write(_get_struct_B().pack(self.action_goal.goal.solution.start_scene.robot_state.is_diff))
      _x = self.action_goal.goal.solution.start_scene.robot_model_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.solution.start_scene.fixed_frame_transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.fixed_frame_transforms:
        _v23 = val1.header
        ...
        _x = _v27
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_values)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_values:
        length = len(val1.enabled)
        buff.write(_struct_I.pack(length))
        pattern = '<%sB'%length
        buff.write(struct.pack(pattern, *val1.enabled))
      length = len(self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values))
      length = len(self.action_goal.goal.solution.start_scene.link_padding)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.link_padding:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.action_goal.goal.solution.start_scene.link_scale)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.link_scale:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.action_goal.goal.solution.start_scene.object_colors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.object_colors:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.action_goal.goal.solution.start_scene.world.collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.world.collision_objects:
        _v29 = val1.header
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.solution.start_scene.world.octomap.header.seq, _x.action_goal.goal.solution.start_scene.world.octomap.header.stamp.secs, _x.action_goal.goal.solution.start_scene.world.octomap.header.stamp.nsecs))
      _x = self.action_goal.goal.solution.start_scene.world.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.action_goal.goal.solution.start_scene.world.octomap.origin.position.x, _x.action_goal.goal.solution.start_scene.world.octomap.origin.position.y, _x.action_goal.goal.solution.start_scene.world.octomap.origin.position.z, _x.action_goal.goal.solution.start_scene.world.octomap.origin.orientation.x, _x.action_goal.goal.solution.start_scene.world.octomap.origin.orientation.y, _x.action_goal.goal.solution.start_scene.world.octomap.origin.orientation.z, _x.action_goal.goal.solution.start_scene.world.octomap.origin.orientation.w, _x.action_goal.goal.solution.start_scene.world.octomap.octomap.header.seq, _x.action_goal.goal.solution.start_scene.world.octomap.octomap.header.stamp.secs, _x.action_goal.goal.solution.start_scene.world.octomap.octomap.header.stamp.nsecs))
      _x = self.action_goal.goal.solution.start_scene.world.octomap.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_goal.goal.solution.start_scene.world.octomap.octomap.binary))
      _x = self.action_goal.goal.solution.start_scene.world.octomap.octomap.id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.action_goal.goal.solution.start_scene.world.octomap.octomap.resolution))
      length = len(self.action_goal.goal.solution.start_scene.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.solution.start_scene.world.octomap.octomap.data))
      buff.write(_get_struct_B().pack(self.action_goal.goal.solution.start_scene.is_diff))
      length = len(self.action_goal.goal.solution.sub_solution)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.sub_solution:
        _v40 = val1.info
        _x = _v40
      ...
      length = len(self.action_goal.goal.solution.sub_trajectory)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.sub_trajectory:
        _v49 = val1.info
        _x = _v49
        buff.write(_get_struct_If().pack(_x.id, _x.cost))
        _x = _v49.comment
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.action_feedback.feedback.sub_id, _x.action_feedback.feedback.sub_no))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.solution.process_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.process_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.solution.task_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.task_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.start_scene.name = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.action_goal.goal.solution.start_scene.robot_state.joint_state.header.seq, _x.action_goal.goal.solution.start_scene.robot_state.joint_state.header.stamp.secs, _x.action_goal.goal.solution.start_scene.robot_state.joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.robot_state.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.start_scene.robot_state.joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.name = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.solution.start_scene.robot_state.joint_state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      (_x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.transforms = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.twist = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.twist.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.wrench = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.robot_state.attached_collision_objects = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.start_scene.robot_state.attached_collision_objects.append(val1)
      start = end
      end += 1
      (self.action_goal.goal.solution.start_scene.robot_state.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.robot_state.is_diff = bool(self.action_goal.goal.solution.start_scene.robot_state.is_diff)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.robot_model_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.start_scene.robot_model_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.fixed_frame_transforms = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.action_goal.goal.solution.start_scene.fixed_frame_transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_values = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.start_scene.allowed_collision_matrix.entry_values.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values = struct.unpack(pattern, str[start:end])
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values = list(map(bool, self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.link_padding = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.start_scene.link_padding.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.link_scale = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.start_scene.link_scale.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.object_colors = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.start_scene.object_colors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.world.collision_objects = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.start_scene.world.collision_objects.append(val1)
      _x = self
      start = end
      end += 12
      (_x.action_goal.goal.solution.start_scene.world.octomap.header.seq, _x.action_goal.goal.solution.start_scene.world.octomap.header.stamp.secs, _x.action_goal.goal.solution.start_scene.world.octomap.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.world.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.start_scene.world.octomap.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.start_scene.world.octomap.octomap.header.frame_id = str[start:end]
      start = end
      end += 1
      (self.action_goal.goal.solution.start_scene.world.octomap.octomap.binary,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.world.octomap.octomap.binary = bool(self.action_goal.goal.solution.start_scene.world.octomap.octomap.binary)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.world.octomap.octomap.id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.solution.start_scene.world.octomap.octomap.id = str[start:end]
      start = end
      end += 8
      (self.action_goal.goal.solution.start_scene.world.octomap.octomap.resolution,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.action_goal.goal.solution.start_scene.world.octomap.octomap.data = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
      (self.action_goal.goal.solution.start_scene.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.is_diff = bool(self.action_goal.goal.solution.start_scene.is_diff)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.sub_solution = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.sub_solution.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.solution.sub_trajectory = []
      for i in range(0, length):
        ...
        self.action_goal.goal.solution.sub_trajectory.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (_x.action_feedback.feedback.sub_id, _x.action_feedback.feedback.sub_no,) = _get_struct_2I().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.solution.start_scene.robot_state.joint_state.position.tostring())
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity.tostring())
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values.tostring())
      length = len(self.action_goal.goal.solution.start_scene.link_padding)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.start_scene.link_padding:
        _x = val1.link_name
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(self.action_goal.goal.solution.start_scene.world.octomap.octomap.data.tostring())
      buff.write(_get_struct_B().pack(self.action_goal.goal.solution.start_scene.is_diff))
      length = len(self.action_goal.goal.solution.sub_solution)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.solution.sub_solution:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      ...
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values = numpy.frombuffer(str[start:end], dtype=numpy.bool, count=length)
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values = list(map(bool, self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.action_goal.goal.solution.start_scene.world.octomap.octomap.data = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=length)
      start = end
      end += 1
      (self.action_goal.goal.solution.start_scene.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.action_goal.goal.solution.start_scene.is_diff = bool(self.action_goal.goal.solution.start_scene.is_diff)
