...
"""autogenerated by genpy from moveit_task_constructor_msgs/Solution.msg. Do not edit."""
import sys
...
class Solution(genpy.Message):
  _md5sum = "f471eaed79942072ef3a9c133a3a7cc1"
  _type = "moveit_task_constructor_msgs/Solution"
...
duration time_from_start
"""
  __slots__ = ['process_id','task_id','start_scene','sub_solution','sub_trajectory']
  _slot_types = ['string','string','moveit_msgs/PlanningScene','moveit_task_constructor_msgs/SubSolution[]','moveit_task_constructor_msgs/SubTrajectory[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       process_id,task_id,start_scene,sub_solution,sub_trajectory
    ...
    """
    if args or kwds:
      super(Solution, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.process_id is None:
        self.process_id = ''
      if self.task_id is None:
        self.task_id = ''
      if self.start_scene is None:
        self.start_scene = moveit_msgs.msg.PlanningScene()
      if self.sub_solution is None:
        self.sub_solution = []
      if self.sub_trajectory is None:
        self.sub_trajectory = []
    else:
      self.process_id = ''
      self.task_id = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.start_scene.robot_state.joint_state.header.seq, _x.start_scene.robot_state.joint_state.header.stamp.secs, _x.start_scene.robot_state.joint_state.header.stamp.nsecs))
      _x = self.start_scene.robot_state.joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.start_scene.robot_state.joint_state.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.robot_state.joint_state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.start_scene.robot_state.joint_state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.start_scene.robot_state.joint_state.position))
      length = len(self.start_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.start_scene.robot_state.joint_state.velocity))
      length = len(self.start_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.start_scene.robot_state.joint_state.effort))
      _x = self
      buff.write(_get_struct_3I().pack(_x.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.start_scene.robot_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.start_scene.robot_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.robot_state.multi_dof_joint_state.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.start_scene.robot_state.multi_dof_joint_state.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.robot_state.multi_dof_joint_state.transforms:
      ...
      length = len(self.start_scene.robot_state.multi_dof_joint_state.twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.robot_state.multi_dof_joint_state.twist:
        _v3 = val1.linear
        _x = _v3
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v4 = val1.angular
        _x = _v4
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.start_scene.robot_state.multi_dof_joint_state.wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.robot_state.multi_dof_joint_state.wrench:
        _v5 = val1.force
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v6 = val1.torque
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.start_scene.robot_state.attached_collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.robot_state.attached_collision_objects:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      buff.write(_get_struct_B().pack(self.start_scene.robot_state.is_diff))
      _x = self.start_scene.robot_model_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.start_scene.fixed_frame_transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.fixed_frame_transforms:
        _v23 = val1.header
        ...
        _x = _v27
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.start_scene.allowed_collision_matrix.entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.allowed_collision_matrix.entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.start_scene.allowed_collision_matrix.entry_values)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.allowed_collision_matrix.entry_values:
        length = len(val1.enabled)
        buff.write(_struct_I.pack(length))
        pattern = '<%sB'%length
        buff.write(struct.pack(pattern, *val1.enabled))
      length = len(self.start_scene.allowed_collision_matrix.default_entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.allowed_collision_matrix.default_entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.start_scene.allowed_collision_matrix.default_entry_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.start_scene.allowed_collision_matrix.default_entry_values))
      length = len(self.start_scene.link_padding)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.link_padding:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.start_scene.link_scale)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.link_scale:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.start_scene.object_colors)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.object_colors:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.start_scene.world.collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.world.collision_objects:
        _v29 = val1.header
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.start_scene.world.octomap.header.seq, _x.start_scene.world.octomap.header.stamp.secs, _x.start_scene.world.octomap.header.stamp.nsecs))
      _x = self.start_scene.world.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.start_scene.world.octomap.origin.position.x, _x.start_scene.world.octomap.origin.position.y, _x.start_scene.world.octomap.origin.position.z, _x.start_scene.world.octomap.origin.orientation.x, _x.start_scene.world.octomap.origin.orientation.y, _x.start_scene.world.octomap.origin.orientation.z, _x.start_scene.world.octomap.origin.orientation.w, _x.start_scene.world.octomap.octomap.header.seq, _x.start_scene.world.octomap.octomap.header.stamp.secs, _x.start_scene.world.octomap.octomap.header.stamp.nsecs))
      _x = self.start_scene.world.octomap.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.start_scene.world.octomap.octomap.binary))
      _x = self.start_scene.world.octomap.octomap.id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.start_scene.world.octomap.octomap.resolution))
      length = len(self.start_scene.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.start_scene.world.octomap.octomap.data))
      buff.write(_get_struct_B().pack(self.start_scene.is_diff))
      length = len(self.sub_solution)
      buff.write(_struct_I.pack(length))
      for val1 in self.sub_solution:
        _v40 = val1.info
        _x = _v40
      ...
      length = len(self.sub_trajectory)
      buff.write(_struct_I.pack(length))
      for val1 in self.sub_trajectory:
        _v49 = val1.info
        _x = _v49
        buff.write(_get_struct_If().pack(_x.id, _x.cost))
        _x = _v49.comment
  ...
  def deserialize(self, str):
    ...
    try:
      if self.start_scene is None:
        self.start_scene = moveit_msgs.msg.PlanningScene()
      if self.sub_solution is None:
        self.sub_solution = None
      if self.sub_trajectory is None:
        self.sub_trajectory = None
      end = 0
      start = end
      end += 4
      ...
      if python3:
        self.start_scene.name = str[start:end].decode('utf-8')
      else:
        self.start_scene.name = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.start_scene.robot_state.joint_state.header.seq, _x.start_scene.robot_state.joint_state.header.stamp.secs, _x.start_scene.robot_state.joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.start_scene.robot_state.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.start_scene.robot_state.joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.robot_state.joint_state.name = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.start_scene.robot_state.joint_state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.start_scene.robot_state.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.start_scene.robot_state.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.start_scene.robot_state.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      (_x.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.start_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.start_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.robot_state.multi_dof_joint_state.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.start_scene.robot_state.multi_dof_joint_state.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.robot_state.multi_dof_joint_state.transforms = []
      for i in range(0, length):
        ...
        self.start_scene.robot_state.multi_dof_joint_state.transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.robot_state.multi_dof_joint_state.twist = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.start_scene.robot_state.multi_dof_joint_state.twist.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.robot_state.multi_dof_joint_state.wrench = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.start_scene.robot_state.multi_dof_joint_state.wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.robot_state.attached_collision_objects = []
      for i in range(0, length):
        ...
        self.start_scene.robot_state.attached_collision_objects.append(val1)
      start = end
      end += 1
      (self.start_scene.robot_state.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.start_scene.robot_state.is_diff = bool(self.start_scene.robot_state.is_diff)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.start_scene.robot_model_name = str[start:end].decode('utf-8')
      else:
        self.start_scene.robot_model_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.fixed_frame_transforms = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.start_scene.fixed_frame_transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.allowed_collision_matrix.entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.start_scene.allowed_collision_matrix.entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.allowed_collision_matrix.entry_values = []
      for i in range(0, length):
        ...
        self.start_scene.allowed_collision_matrix.entry_values.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.allowed_collision_matrix.default_entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.start_scene.allowed_collision_matrix.default_entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.start_scene.allowed_collision_matrix.default_entry_values = struct.unpack(pattern, str[start:end])
      self.start_scene.allowed_collision_matrix.default_entry_values = list(map(bool, self.start_scene.allowed_collision_matrix.default_entry_values))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.link_padding = []
      for i in range(0, length):
        ...
        self.start_scene.link_padding.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.link_scale = []
      for i in range(0, length):
        ...
        self.start_scene.link_scale.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.object_colors = []
      for i in range(0, length):
        ...
        self.start_scene.object_colors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.start_scene.world.collision_objects = []
      for i in range(0, length):
        ...
        self.start_scene.world.collision_objects.append(val1)
      _x = self
      start = end
      end += 12
      (_x.start_scene.world.octomap.header.seq, _x.start_scene.world.octomap.header.stamp.secs, _x.start_scene.world.octomap.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.start_scene.world.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.start_scene.world.octomap.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      ...
      if python3:
        self.start_scene.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.start_scene.world.octomap.octomap.header.frame_id = str[start:end]
      start = end
      end += 1
      (self.start_scene.world.octomap.octomap.binary,) = _get_struct_B().unpack(str[start:end])
      self.start_scene.world.octomap.octomap.binary = bool(self.start_scene.world.octomap.octomap.binary)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.start_scene.world.octomap.octomap.id = str[start:end].decode('utf-8')
      else:
        self.start_scene.world.octomap.octomap.id = str[start:end]
      start = end
      end += 8
      (self.start_scene.world.octomap.octomap.resolution,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.start_scene.world.octomap.octomap.data = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
      (self.start_scene.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.start_scene.is_diff = bool(self.start_scene.is_diff)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.sub_solution = []
      ...
      for i in range(0, length):
        ...
        self.sub_trajectory.append(val1)
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.start_scene.robot_state.joint_state.position.tostring())
      length = len(self.start_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.start_scene.robot_state.joint_state.velocity.tostring())
      length = len(self.start_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.start_scene.robot_state.joint_state.effort.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.start_scene.robot_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(self.start_scene.allowed_collision_matrix.default_entry_values.tostring())
      length = len(self.start_scene.link_padding)
      buff.write(_struct_I.pack(length))
      for val1 in self.start_scene.link_padding:
        _x = val1.link_name
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(self.start_scene.world.octomap.octomap.data.tostring())
      buff.write(_get_struct_B().pack(self.start_scene.is_diff))
      length = len(self.sub_solution)
      buff.write(_struct_I.pack(length))
      for val1 in self.sub_solution:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.start_scene.robot_state.joint_state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.start_scene.robot_state.joint_state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.start_scene.robot_state.joint_state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.start_scene.robot_state.multi_dof_joint_state.header.seq, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.start_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      ...
      self.start_scene.allowed_collision_matrix.default_entry_values = numpy.frombuffer(str[start:end], dtype=numpy.bool, count=length)
      self.start_scene.allowed_collision_matrix.default_entry_values = list(map(bool, self.start_scene.allowed_collision_matrix.default_entry_values))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.start_scene.world.octomap.octomap.data = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=length)
      start = end
      end += 1
      (self.start_scene.is_diff,) = _get_struct_B().unpack(str[start:end])
      self.start_scene.is_diff = bool(self.start_scene.is_diff)
