...
// (in-package moveit_task_constructor_msgs.srv)
...
let Solution = require('../msg/Solution.js');
...
class GetSolutionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('solution_id')) {
        this.solution_id = initObj.solution_id
      }
      else {
        this.solution_id = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetSolutionRequest
    // Serialize message field [solution_id]
    bufferOffset = _serializer.uint32(obj.solution_id, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetSolutionRequest
    let len;
    let data = new GetSolutionRequest(null);
    // Deserialize message field [solution_id]
    data.solution_id = _deserializer.uint32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetSolutionRequest(null);
    if (msg.solution_id !== undefined) {
      resolved.solution_id = msg.solution_id;
    }
    else {
      resolved.solution_id = 0
    }
...
class GetSolutionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetSolutionResponse
    // Serialize message field [solution]
    bufferOffset = Solution.serialize(obj.solution, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetSolutionResponse
    let len;
    let data = new GetSolutionResponse(null);
    // Deserialize message field [solution]
    data.solution = Solution.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Solution.getMessageSize(object.solution);
    return length;
  }

  static datatype() {
    // Returns string type for a service object
    return 'moveit_task_constructor_msgs/GetSolutionResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f7004e140d59ff3952fa761d4bc31d0e';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetSolutionResponse(null);
    if (msg.solution !== undefined) {
      resolved.solution = Solution.Resolve(msg.solution)
    }
    else {
      resolved.solution = new Solution()
    }
...
module.exports = {
  ...
  md5sum() { return '7b2d5747af4b538b9e0ff8d9e2919f3b'; },
  datatype() { return 'moveit_task_constructor_msgs/GetSolution'; }
};
