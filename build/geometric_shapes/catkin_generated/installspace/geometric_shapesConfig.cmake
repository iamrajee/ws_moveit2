...
if(NOT "include;/usr/include/eigen3;/opt/ros/melodic/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rajendra/ws_moveit/install/${idir}'.  ${_report}")
    endif()
